    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(requests ->requests
                        ...
                        .hasAnyRole("USER")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/book/**","/api/v1/bookcategory/**","/api/v1/author/**","/api/v1/author","/api/v1/publisher/**","/api/v1/order/status/**")
                        .hasAnyRole("MANAGER", "ADMIN")
                        ...
                        .hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/user/manager/**")
                        .hasAnyRole("MANAGER")
